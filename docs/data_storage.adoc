...
With regards to the layout of the MongoDB database, we will define as many collections as we have different kinds of data ; one for historical stock values, one for streaming/recent stock values, one for additional company information, ...
