...
from opa.core.auth import Authenticator


class JsonCredentialsAuthenticator(Authenticator):
    ...
    def write_credentials(self, username: str, hashed_password: bytes):
...
auth = JsonCredentialsAuthenticator("app_data/secrets/creds.json")
